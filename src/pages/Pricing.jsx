            ...
            <Center color="white" textAlign="left" w="100%">
              <Flex alignItems="center" justify="space-around">
                ...
                <VStack alignItem="start" justify="space-around">
                  ...
                  <p>0</p>
                  <p>
                    {(query.value * (query.percentage / 100) * 0.0332).toFixed(
                      2
                    )}
                  </p>
                </VStack>
          ...
          <StyledAccordian allowToggle>
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                ...
                <TextDiv>
                  ...
                  (‘payment gateway charges’). These charges on crowdfunding
                  websites are unavoidable.
                </TextDiv>
                <br />
                <TextDiv>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                ...
                <TextDiv>
                  <p>
                    For donations made in US Dollars using a card issued in the
                    USA (USD): 2.9% + 30cents per donation
                  </p>
                  <p>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                <TextDiv>
                  ...
                  Milaap is covering for this without passing it to the campaign
                  organizers. This means NO charges to withdraw funds.
                </TextDiv>
                <br />
                <TextDiv>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                <TextDiv>
                  You might be wondering, “What percentage does Milaap take?“ or
                  “Does Milaap make any money?” We have a 0% platform fee. We
                  rely on the generosity of our users to power the platform.
                </TextDiv>
                <br />
                <TextDiv>
                  10 years into our journey, we are taking the belief in our
                  community to the next level. With this 0% platform fee, we are
                  incredibly grateful for the voluntary tips from our users to
                  help with the costs associated with paying our dedicated
                  employees, providing our best-in-class customer service, trust
                  & safety protections, and social fundraising technology.
                </TextDiv>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                <TextDiv>
                  ...
                  organizations alike. In fact, organizations with 80G
                  tax-exempt status also have the option to either issue
                  tax-exemption receipts from Milaap's dashboard or issue it
                  separately. Receipts to donors from Milaap's dashboard can be
                  issued, at a click of a button. This feature is FREE to use
                  and entails NO FEES.
                </TextDiv>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} textAlign="left">
                <TextDiv>
                  ...
                  for FREE using our best-in-class social fundraising technology
                  and round-the-clock assistance and support from our
                  relationship managers.
                </TextDiv>
                <br />
                <TextDiv>
                  In certain scenarios, where the beneficiaries come from a
                  disadvantaged backgrounds with no digital literacy, exhausted
                  most of their finances with no other sources available and
                  require funds very urgently; Milaap may consider them on a
                  case-by-case basis for outreach on social media and digital
                  promotion platforms after verification and a signed request
                  letter from the beneficiary. This is subject to availability
                  of our team members, and situations where we beleive
                  promotions can achieve something significant for the cause.
                </TextDiv>
                <br />
                <TextDiv>
