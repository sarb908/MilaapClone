import { Flex, Box, Text, Center, Heading, Button, Image, useDisclosure, Modal, ModalBody, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, Select } from '@chakra-ui/react'
        ...
        <Box w={"100%"} minH={"120px"} bgColor={"#9c3353"} mt={"4%"}>
            ...
            <Box mt={"2%"} minH={"80px"} w={"85%"} borderRadius={"12px"} shadow={"rgba(0, 0, 0, 0.35) 0px 5px 15px"} bgColor={"whitesmoke"}>
                <Flex mt={"1%"} alignItems={"center"} justifyContent={"space-around"}>
                    ...
                    <Button fontSize={"20px"} color={"white"} bg={"#9c3353"} borderRadius={"18px"} padding={"2%"} onClick={onOpen}>
                        <Center>
                        <Flex gap={"4%"}>
                    ...
                    <ModalContent>
                        <ModalHeader>
                            <Center>
                                <Flex gap={"4%"}>
                                    ...
                                    <Text mt={"12%"} fontSize={"sm"}>Milaan</Text>
                                </Flex>
                            </Center>
                        </ModalHeader>
                        <ModalCloseButton />
                        ...
                        <Text mt={"5%"} mb={"5%"}>Fill your details & we will connect with you shortly</Text>
                            <form style={{width: "100%"}}>
                                <input style={{width: "100%", height: "40px",border: "1px solid black", marginBottom: "3%"}} type="text" placeholder='Name' /><br />
                                <input style={{width: "100%", height: "40px",border: "1px solid black", marginTop: "2%",marginBottom: "2%"}} type="number" placeholder='Phone Number' /><br />
                                <Text fontSize={"sm"}>We will contact you on this number</Text>
                                <Select style={{marginTop: "2%"}} placeholder='Why are you fundraising'>
                                ...
                                <Select style={{marginTop: "2%"}} placeholder='Preffered language'>
                                ...
                                <Center>
                                    <Button mt={"4%"} type="submit" color= "white" bgColor={"#9c3353"}>Submit</Button>
                                </Center>   
                            </form>
                        </ModalBody>
                    </ModalContent>
            ...
            <ReviewCard />
        <Center>
            <Link to={"/review"}><Text color={"#9c3353"} fontSize={"sm"} as={"u"}>See all reviews</Text></Link>
        </Center>  
    </div>
  )
}
