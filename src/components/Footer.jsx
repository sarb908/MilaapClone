...
import { FaTwitter, FaYoutube, FaInstagram, FaMemory, FaStethoscope,
FaMas,
FaBookOpen, FaLinkedin,
        ...
        direction={{base:'row', md:'column', sm:'column'}}>
          ...
          <Stack align={'flex-start'} width='170px'>
            ...
            <Link href={'#'} 
                ...
                <Box><Center><FaStethoscope color='#9c3353'/></Center></Box>
                <Box><Center>
                    <Text color={'#6c6c6c'} fontSize={'13px'} fontWeight={'400'}>Medical</Text>
                    </Center>
                </Box>
                </Flex>
            </Link>
            <Link href={'#'}
             _hover={{
                ...
                <Flex gap='4' marginTop="1">
                <Box><Center><FaBookOpen color='#9c3353'/></Center></Box>
                <Box><Center><Text color={'#6c6c6c'} fontSize={'13px'} fontWeight={'400'}>
                    Education</Text></Center></Box>
                </Flex>
            </Link>
            <Link href={'#'} 
             _hover={{
                ...
                <Flex gap='4' marginTop="1">
                <Box><Center><FaMemory color='#9c3353'/></Center></Box>
                <Box><Center><Text color={'#6c6c6c'} fontSize={'13px'} fontWeight={'400'}>
                    Memorial</Text></Center></Box>
                </Flex>
            </Link>
          </Stack>
          ...
          <Flex gap={'12px'} align={'center'}>
            <Box>
            <Link href={'/pricing'} color='#9c3353' fontSize={'13px'} fontWeight={'400'}
                _hover={{
                    textDecoration: "none",
                  }}>Pricing</Link>
            </Box>
